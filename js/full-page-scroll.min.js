! function () {
    ...
    var t = function (t) {
        var e = document.getElementById("main"),
            n = e.getElementsByTagName("section"),
            s = {
                container: e,
                sections: n,
                animateTime: t.animateTime || .7,
                animateFunction: t.animateFunction || "ease",
                maxPosition: n.length - 1,
                currentPosition: 0,
                displayDots: "undefined" != typeof t.displayDots ? t.displayDots : !0,
                dotsPosition: t.dotsPosition || "left"
            };
        this.defaults = s, this.init()
    };
    t.prototype.init = function () {
        this.buildSections().buildDots().buildPublicFunctions().addEvents();
        var t = location.hash.replace("#", "").split("/")[0];
        location.hash = 0, this.changeCurrentPosition(t)
    }, t.prototype.buildSections = function () {
        for (var t = this.defaults.sections, e = 0; e < t.length; e++) t[e].setAttribute("data-index", e);
        return this
    }, t.prototype.buildDots = function () {
        this.ul = document.createElement("ul"), this.ul.classList.add("dots"), this.ul.classList.add("right" == this.defaults.dotsPosition ? "dots-right" : "dots-left");
        for (var t = this, e = this.defaults.sections, n = 0; n < e.length; n++) {
            var s = document.createElement("li"),
                i = document.createElement("a");
            i.setAttribute("href", "#" + n), s.appendChild(i), t.ul.appendChild(s)
        }
        return this.ul.childNodes[0].firstChild.classList.add("active"), this.defaults.displayDots && document.body.appendChild(this.ul), this
        ...
        return this.mouseWheelAndKey = function (t) {
            t.deltaY > 0 || 40 == t.keyCode ? (n.defaults.currentPosition++, n.changeCurrentPosition(n.defaults.currentPosition)) : (t.deltaY < 0 || 38 == t.keyCode) && (n.defaults.currentPosition--, n.changeCurrentPosition(n.defaults.currentPosition)), n.removeEvents()
        }, this.touchStart = function (n) {
            t = parseInt(n.changedTouches[0].clientY), e = 0
        }, this.touchEnd = function (s) {
            e = parseInt(s.changedTouches[0].clientY), (e - t > 100 || t - e > 100) && (e > t ? n.defaults.currentPosition-- : n.defaults.currentPosition++, n.changeCurrentPosition(n.defaults.currentPosition))
        }, this.hashChange = function (t) {
            if (location) {
                var e = location.hash.replace("#", "").split("/")[0];
                "" !== e && (0 > e ? n.changeCurrentPosition(0) : e > n.defaults.maxPosition ? n.changeCurrentPosition(n.defaults.maxPosition) : (n.defaults.currentPosition = e, n.animateScroll()))
            }
            ...
            var t = this.defaults.animateTime,
                ...
                n = 100 * this.defaults.currentPosition;
            ...
            for (var s = 0; s < this.ul.childNodes.length; s++) this.ul.childNodes[s].firstChild.classList.remove("active"), s == this.defaults.currentPosition && this.ul.childNodes[s].firstChild.classList.add("active")
        }, this.changeCurrentPosition = function (t) {
            "" !== t && (n.defaults.currentPosition = t, location.hash = n.defaults.currentPosition)
        }, this
    }, window.fullScroll = t
}();