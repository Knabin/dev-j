        ...
        this.animateScroll = function () {
            ...
            if (window.innerWidth >= 756) {
                ...
                for (var i = 0; i < this.ul.childNodes.length; i++) {
                    console.log(this.ul.childNodes[i].firstChild.classList);
                ...
                //                var positon = this.defaults.currentPosition * 50;
                this.defaults.container.style.transform = 'none';
                this.defaults.container.style.transition = 'none';
            }
